...
import { BookOpen, Search, Lightbulb, Star, Users, GraduationCap, Clock, Play, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function SermonCreationStudio() {
  ...
  const sermonSteps = [
    { id: "sermon-research", label: "Research", number: 1 },
    { id: "sermon-outline", label: "Outline", number: 2 },
    { id: "sermon-enhance", label: "Enhance", number: 3 },
    { id: "sermon-complete", label: "Complete", number: 4 }
  ];

  const sundaySchoolSteps = [
    { id: "lesson-plan", label: "Lesson Plan", number: 1 },
    { id: "activities", label: "Activities", number: 2 },
    { id: "materials", label: "Materials", number: 3 },
    { id: "assessment", label: "Assessment", number: 4 }
  ];

  const getCurrentSteps = () => mainTab === "sermon" ? sermonSteps : sundaySchoolSteps;
  ...
  const handleStart = () => {
    setHasStarted(true);
    setCurrentStep(1);
    setActiveTab(mainTab === "sermon" ? "sermon-research" : "lesson-plan");
  };
      ...
      <CardContent className="pt-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-blue-700 dark:text-blue-300">
            {mainTab === "sermon" ? "Sermon Creation" : "Sunday School Lesson"} Progress
          </h3>
            ...
            <div key={step.id} className="flex-1">
              ...
              <div className="mt-2">
                <p className={`text-xs font-medium ${
                  currentStep >= step.number ? 'text-blue-700 dark:text-blue-300' : 'text-gray-500'
                }`}>
                  {step.label}
                </p>
              </div>
  ...
  const NavigationButtons = ({ steps, currentStep, onBack, onNext }: any) => (
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 space-y-6">
      ...
      <Tabs value={mainTab} onValueChange={(value) => {
        ...
        setHasStarted(false);
        setCurrentStep(1);
        setActiveTab(value === "sermon" ? "sermon-research" : "lesson-plan");
      }} className="space-y-6">
        ...
        <TabsContent value="sermon" className="space-y-6">
          <ProgressBar steps={sermonSteps} currentStep={getCurrentStepNumber()} />
            ...
            <Card className="border-l-4 border-l-blue-500 bg-gradient-to-r from-blue-50/50 to-white dark:from-blue-900/10 dark:to-gray-800">
              ...
              <CardContent className="pt-6">
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">AI-Powered Sermon Creation</h3>
                  <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto mb-6">
                    Let our AI assistant guide you through creating a compelling sermon with research, structure, and enhancement.
                  </p>
                  <Button onClick={handleStart} className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 shadow-lg">
                    <BookOpen className="w-4 h-4 mr-2" />
                    Start Sermon Creation
                  </Button>
                </div>
              </CardContent>
            </Card>
        ...
        <TabsContent value="sunday-school" className="space-y-6">
          <ProgressBar steps={sundaySchoolSteps} currentStep={getCurrentStepNumber()} />
            ...
            <Card className="border-l-4 border-l-purple-500 bg-gradient-to-r from-purple-50/50 to-white dark:from-purple-900/10 dark:to-gray-800">
              <CardHeader>
                <CardTitle className="flex items-center text-purple-700 dark:text-purple-300">
                  ...
                  Ready to Create Your Sunday School Lesson?
                </CardTitle>
              </CardHeader>
              <CardContent className="pt-6">
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto mb-6">
                    Create engaging, age-appropriate Sunday School lessons with activities, materials, and assessment tools.
                  </p>
                  <Button onClick={handleStart} className="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 shadow-lg">
                    <GraduationCap className="w-4 h-4 mr-2" />
