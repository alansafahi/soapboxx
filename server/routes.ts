  ...
  app.post('/api/volunteer/opportunities', isAuthenticated, async (req: any, res) => {
    try {
      ...
      const opportunityData = {
        ...
        spiritualGifts: Array.isArray(spiritualGiftsNeeded) ? spiritualGiftsNeeded : [], // Map spiritualGiftsNeeded → spiritualGifts
        ...
        teamSize: teamSize,
        teamRoles: Array.isArray(teamRoles) ? teamRoles : [],
