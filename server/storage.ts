...
import {
  ...
  // Scoring system imports - re-added the missing tables and types
  userScores,
  pointTransactions,
  leaderboards,
  leaderboardEntries,
  ...
  // Scoring system type imports - re-added the missing ones
  type UserScore,
    ...
    try {
      ...
      const planResult = await pool.query(`
        INSERT INTO reading_plans (
          name, description, type, duration, difficulty, subscription_tier, category, 
      ...
      `, [
        ...
        'devotional', // Type is required - use 'devotional' for AI-generated plans
