    ...
    try {
      ...
      const [opportunity] = await db
        ...
        .values({
          ...
          spiritualGifts: Array.isArray(data.spiritualGifts) ? data.spiritualGifts : [],
          ...
          leadershipRequired: data.leadershipRequired,
          performanceMetrics: Array.isArray(data.performanceMetrics) ? data.performanceMetrics : [],
          trainingRequired: data.trainingRequired,
          orientationRequired: data.orientationRequired,
          mentorshipProvided: data.mentorshipProvided,
          backgroundCheckLevel: data.backgroundCheckLevel,
