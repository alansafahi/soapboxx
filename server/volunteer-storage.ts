    ...
    try {
      const [opportunity] = await db
        ...
        .values({
          ...
          spiritual_gifts: data.spiritualGiftsNeeded || [],
          time_commitment: data.timeCommitment,
          time_commitment_level: data.timeCommitmentLevel,
          ...
          leadership_required: data.leadershipRequired,
          performance_metrics: data.performanceMetrics || [],
          training_required: data.trainingRequired,
          orientation_required: data.orientationRequired,
          mentorship_provided: data.mentorshipProvided,
          background_check_level: data.backgroundCheckLevel,
