...
// Enhanced role definitions with three new platform-wide roles
export const ENHANCED_ROLE_DEFINITIONS = [
  {
    name: "soapbox_owner",
    displayName: "SoapBox Owner",
    description: "Ultimate platform authority with governance over all policies, roles, security and audits",
    level: 0,
    scope: "platform",
    icon: "shield-check",
    color: "#7C3AED",
    permissions: [
      ...
      "platform.churches.manage.all",
      "platform.marketplace.manage",
      "platform.finance.authority",
      "platform.communications.global",
      ...
      "billing.manage.global",
      "integrations.manage.all",
      "backups.manage",
      "audit.logs.access.full",
      "impersonation.all.users",
      "feature.flags.manage",
      "notifications.platform.send"
    ],
    canManageRoles: ["system_admin", "support_agent", "regional_admin", "super_admin", "church_admin", "lead_pastor", "pastor", "minister", "social_manager", "staff", "member"]
  },
  {
    name: "system_admin",
    displayName: "System Admin",
    description: "Full platform access across all churches, users, logs, billing, settings and moderation",
    level: 1,
    scope: "platform",
    icon: "settings-2",
    color: "#DC2626",
    permissions: [
      "platform.churches.view.all",
      "platform.churches.manage.all",
      "platform.users.manage.all",
      "platform.analytics.cross_church",
      "platform.security.compliance",
    ...
    canManageRoles: ["support_agent", "regional_admin", "super_admin", "church_admin", "lead_pastor", "pastor", "minister", "social_manager", "staff", "member"]
  },
  {
    name: "support_agent",
    displayName: "Support Agent",
    description: "Platform-wide support access for user assistance, troubleshooting and issue escalation",
    level: 2,
    scope: "platform",
    icon: "headphones",
    color: "#059669",
    permissions: [
      ...
      "support.billing.assist",
      "support.knowledge.maintain",
      "support.feedback.collect",
      "users.view.all",
      "users.impersonate.support",
      "churches.view.all",
      "content.moderate.flagged",
      "content.flag.inappropriate",
      "prayers.moderate",
      "discussions.moderate",
      "analytics.view.support",
      "audit.logs.view.support",
      "billing.view.support",
      "tickets.create.escalate"
    ],
    canManageRoles: []
  },
  {
