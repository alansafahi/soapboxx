...
export const comprehensiveKnowledge: KnowledgeEntry[] = [
  ...
  },
  {
    ...
    content: 'SoapBox Super App Pricing: Individual Plans - Disciple Plan (FREE, 250 credits/month), Servant Plan ($5/month, 500 credits), Kingdom Builder Plan ($10/month, 1,000 credits). Church Plans - Pastor Essential ($50/month, 5,000 credits), Shepherd Advanced ($100/month, 10,000 credits). All plans include spiritual growth tools with biblical inspiration.',
    helpLink: '/faq#pricing',
    priority: 10,
  ...
  },
  {
    ...
    content: 'Pastor Essential Plan: $50/month with 5,000 credits/month - "Foundational ministry tools". Includes Church Member Directory, Event Planning & Management, Communication Hub, Prayer Request Management, Basic Volunteer Coordination, and 2,500 loyalty credits every 6 months.',
    helpLink: '/faq#pricing',
    priority: 9,
    lastUpdated: '2025-08-05',
    source: 'website'
  },
  {
    ...
    content: 'Shepherd Advanced Plan: $100/month with 10,000 credits/month - "Comprehensive ministry platform". Includes everything in Pastor Essential plus AI-Powered Sermon Studio, Advanced Analytics & Insights, Enhanced Volunteer Management, Multi-Campus Support, Priority Support, and 5,000 loyalty credits every 6 months.',
    helpLink: '/faq#pricing',
    priority: 9,
    lastUpdated: '2025-08-05',
    source: 'website'
