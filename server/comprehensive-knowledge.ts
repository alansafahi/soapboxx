...
export const comprehensiveKnowledge: KnowledgeEntry[] = [
  ...
  },
  {
    ...
    content: 'Servant Plan: $5/month ($50/year) with 500 credits/month - "Serve faithfully and grow deeply". Includes everything in Disciple Plan plus Comprehensive Spiritual Gifts Assessment (120 questions), Bible Study Tools, Enhanced Volunteer opportunity matching, and AI Engagement Analytics.',
    helpLink: '/faq#pricing',
    priority: 9,
    lastUpdated: '2025-07-17',
    source: 'website'
  },
  {
    ...
    content: 'Kingdom Builder Plan: $10/month ($100/year) with 1,000 credits/month - "Lead others. Build God\'s Kingdom." Includes everything in Servant Plan plus AI-Powered Audio Bible, AI Video Content Generation, Unlimited offline content access, and Early access to new features.',
    helpLink: '/faq#pricing',
    priority: 9,
    lastUpdated: '2025-07-17',
    source: 'website'
  ...
  },
  {
    ...
    content: 'Shepherd Plan: $50/month with 5,000 credits/month - "Guide your flock with love and order". Includes Member Management, Event Planning, Church-Wide Communication Tools, Private Prayer Circle Coordination, and 2,500 loyalty credits every 6 months. Great for churches starting their digital ministry journey.',
    helpLink: '/faq#pricing',
    priority: 9,
    lastUpdated: '2025-08-05',
    source: 'website'
  },
  {
    ...
    content: 'Beacon Plan: $100/month with 10,000 credits/month - "Shine brighter, reach farther". Includes everything in Shepherd Plan plus Advanced Analytics on Engagement, Sermon Studio for Content Sharing, Integration with SoapBox AI Tools, and 5,000 loyalty credits every 6 months. Best for churches aiming to grow their reach and maximize impact.',
    helpLink: '/faq#pricing',
    priority: 9,
    lastUpdated: '2025-08-05',
    source: 'website'
  ...
  {
    id: 'pricing-church-kingdom',
    category: 'pricing',
    subcategory: 'church',
    keywords: ['kingdom plan', 'church premium', '$250', '25000 credits', 'mega church', 'multi-campus'],
    content: 'Kingdom Plan: $250/month with 25,000 credits/month - "Lead with vision, empower the body". Includes everything in Beacon Plan plus AI-Enhanced Content Creation, Multi-Campus Management, Donor & Giving Analytics, Livestream Integration & Media Hub, Volunteer Management System, and Real-time Ministry Chat + CRM. Ideal for high-growth or mega churches ready to scale spiritual leadership and community management.',
    helpLink: '/faq#pricing',
    priority: 9,
