...
function generateMoreVerses() {
  ...
  return [
    ...
    { reference: "Psalm 139:14", book: "Psalms", chapter: 139, verse: "14", text: "I praise you because I am fearfully and wonderfully made; your works are wonderful, I know that full well.", translation: "NIV", topicTags: ["identity", "creation", "praise"], category: "core", popularityScore: 8 },
    { reference: "Psalm 46:10", book: "Psalms", chapter: 46, verse: "10", text: "Be still, and know that I am God; I will be exalted among the nations, I will be exalted in the earth.", translation: "NIV", topicTags: ["peace", "stillness", "sovereignty"], category: "core", popularityScore: 9 },
    { reference: "Psalm 34:8", book: "Psalms", chapter: 34, verse: "8", text: "Taste and see that the Lord is good; blessed is the one who takes refuge in him.", translation: "NIV", topicTags: ["goodness", "blessing", "refuge"], category: "devotional", popularityScore: 7 },
    
    // Proverbs - Wisdom verses
    { reference: "Proverbs 16:3", book: "Proverbs", chapter: 16, verse: "3", text: "Commit to the Lord whatever you do, and he will establish your plans.", translation: "NIV", topicTags: ["planning", "commitment", "trust"], category: "core", popularityScore: 8 },
    { reference: "Proverbs 27:17", book: "Proverbs", chapter: 27, verse: "17", text: "As iron sharpens iron, so one person sharpens another.", translation: "NIV", topicTags: ["friendship", "growth", "relationships"], category: "topical", popularityScore: 8 },
    { reference: "Proverbs 31:25", book: "Proverbs", chapter: 31, verse: "25", text: "She is clothed with strength and dignity; she can laugh at the days to come.", translation: "NIV", topicTags: ["strength", "dignity", "confidence"], category: "devotional", popularityScore: 7 },
    { reference: "Proverbs 18:24", book: "Proverbs", chapter: 18, verse: "24", text: "One who has unreliable friends soon comes to ruin, but there is a friend who sticks closer than a brother.", translation: "NIV", topicTags: ["friendship", "loyalty", "relationships"], category: "topical", popularityScore: 6 },
    
    // Matthew - Jesus' teachings
    { reference: "Matthew 5:14-16", book: "Matthew", chapter: 5, verse: "14-16", text: "You are the light of the world. A town built on a hill cannot be hidden. Neither do people light a lamp and put it under a bowl. Instead they put it on its stand, and it gives light to everyone in the house. In the same way, let your light shine before others, that they may see your good deeds and glorify your Father in heaven.", translation: "NIV", topicTags: ["witness", "light", "good deeds"], category: "core", popularityScore: 9 },
    { reference: "Matthew 11:28-30", book: "Matthew", chapter: 11, verse: "28-30", text: "Come to me, all you who are weary and burdened, and I will give you rest. Take my yoke upon you and learn from me, for I am gentle and humble in heart, and you will find rest for your souls. For my yoke is easy and my burden is light.", translation: "NIV", topicTags: ["rest", "burden", "gentle"], category: "core", popularityScore: 10 },
    { reference: "Matthew 6:26", book: "Matthew", chapter: 6, verse: "26", text: "Look at the birds of the air; they do not sow or reap or store away in barns, and yet your heavenly Father feeds them. Are you not much more valuable than they?", translation: "NIV", topicTags: ["provision", "worry", "value"], category: "core", popularityScore: 8 },
    { reference: "Matthew 28:19-20", book: "Matthew", chapter: 28, verse: "19-20", text: "Therefore go and make disciples of all nations, baptizing them in the name of the Father and of the Son and of the Holy Spirit, and teaching them to obey everything I have commanded you. And surely I am with you always, to the very end of the age.", translation: "NIV", topicTags: ["mission", "discipleship", "presence"], category: "core", popularityScore: 9 },
    
    // John - Love and truth
    { reference: "John 15:13", book: "John", chapter: 15, verse: "13", text: "Greater love has no one than this: to lay down one's life for one's friends.", translation: "NIV", topicTags: ["love", "sacrifice", "friendship"], category: "core", popularityScore: 8 },
    { reference: "John 8:32", book: "John", chapter: 8, verse: "32", text: "Then you will know the truth, and the truth will set you free.", translation: "NIV", topicTags: ["truth", "freedom", "knowledge"], category: "core", popularityScore: 9 },
    { reference: "John 10:10", book: "John", chapter: 10, verse: "10", text: "The thief comes only to steal and kill and destroy; I have come that they may have life, and have it to the full.", translation: "NIV", topicTags: ["life", "purpose", "abundant"], category: "core", popularityScore: 9 },
    { reference: "John 15:5", book: "John", chapter: 15, verse: "5", text: "I am the vine; you are the branches. If you remain in me and I in you, you will bear much fruit; apart from me you can do nothing.", translation: "NIV", topicTags: ["connection", "fruit", "dependence"], category: "core", popularityScore: 8 },
    
    // Romans - Salvation and life
    { reference: "Romans 8:28", book: "Romans", chapter: 8, verse: "28", text: "And we know that in all things God works for the good of those who love him, who have been called according to his purpose.", translation: "NIV", topicTags: ["purpose", "good", "calling"], category: "core", popularityScore: 10 },
    { reference: "Romans 12:2", book: "Romans", chapter: 12, verse: "2", text: "Do not conform to the pattern of this world, but be transformed by the renewing of your mind. Then you will be able to test and approve what God's will is—his good, pleasing and perfect will.", translation: "NIV", topicTags: ["transformation", "mind", "will"], category: "core", popularityScore: 8 },
    { reference: "Romans 5:8", book: "Romans", chapter: 5, verse: "8", text: "But God demonstrates his own love for us in this: While we were still sinners, Christ died for us.", translation: "NIV", topicTags: ["love", "sacrifice", "grace"], category: "core", popularityScore: 9 },
    { reference: "Romans 15:13", book: "Romans", chapter: 15, verse: "13", text: "May the God of hope fill you with all joy and peace as you trust in him, so that you may overflow with hope by the power of the Holy Spirit.", translation: "NIV", topicTags: ["hope", "joy", "peace"], category: "devotional", popularityScore: 7 },
    
    // 1 Corinthians - Church life and love
    { reference: "1 Corinthians 13:4-7", book: "1 Corinthians", chapter: 13, verse: "4-7", text: "Love is patient, love is kind. It does not envy, it does not boast, it is not proud. It does not dishonor others, it is not self-seeking, it is not easily angered, it keeps no record of wrongs. Love does not delight in evil but rejoices with the truth. It always protects, always trusts, always hopes, always perseveres.", translation: "NIV", topicTags: ["love", "patience", "kindness"], category: "core", popularityScore: 10 },
    { reference: "1 Corinthians 10:13", book: "1 Corinthians", chapter: 10, verse: "13", text: "No temptation has overtaken you except what is common to mankind. And God is faithful; he will not let you be tempted beyond what you can bear. But when you are tempted, he will also provide a way out so that you can endure it.", translation: "NIV", topicTags: ["temptation", "faithfulness", "endurance"], category: "core", popularityScore: 8 },
    { reference: "1 Corinthians 16:14", book: "1 Corinthians", chapter: 16, verse: "14", text: "Do everything in love.", translation: "NIV", topicTags: ["love", "actions", "everything"], category: "devotional", popularityScore: 7 },
    
    // 2 Corinthians - Strength in weakness
    { reference: "2 Corinthians 12:9", book: "2 Corinthians", chapter: 12, verse: "9", text: "But he said to me, 'My grace is sufficient for you, for my power is made perfect in weakness.' Therefore I will boast all the more gladly about my weaknesses, so that Christ's power may rest on me.", translation: "NIV", topicTags: ["grace", "weakness", "power"], category: "core", popularityScore: 9 },
    { reference: "2 Corinthians 4:16-17", book: "2 Corinthians", chapter: 4, verse: "16-17", text: "Therefore we do not lose heart. Though outwardly we are wasting away, yet inwardly we are being renewed day by day. For our light and momentary troubles are achieving for us an eternal glory that far outweighs them all.", translation: "NIV", topicTags: ["perseverance", "renewal", "glory"], category: "devotional", popularityScore: 7 },
    { reference: "2 Corinthians 5:17", book: "2 Corinthians", chapter: 5, verse: "17", text: "Therefore, if anyone is in Christ, the new creation has come: The old has gone, the new is here!", translation: "NIV", topicTags: ["transformation", "new creation", "Christ"], category: "core", popularityScore: 9 }
  ];
}
